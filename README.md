...
```bash
curl -L https://raw.githubusercontent.com/rrandriamana/raspoppy/scratch/raspoppyfication.sh -o /tmp/raspoppyfication.sh
chmod +x /tmp/raspoppyfication.sh
sudo /tmp/raspoppyfication.sh --branch=scratch 
```
